...
Peekaboo.serveReturnScripts = {
  ...
  "6-8": [
    ...
    { serve: "宝宝反复拍打桌面或敲打物品", ret: "在她旁边也拍几下同样的节奏，然后变一个新节奏——\"嘣嘣嘣！换你来！\"", principle: "节奏模仿是音乐认知和轮流互动的双重训练" },
    { serve: "宝宝在趴姿时抬头注视某样东西", ret: "把那样东西拿到她够得着的距离，说\"你想要这个！来，伸手够够看~\"", principle: "趴姿时的目标导向行为是主动探索的起点" },
  ],
  "8-10": [
...
Peekaboo.gameDB = {
  ...
  // 阶段2: 校正6-8月 - 主动探索期
  // 工作日+周末均采用 A/B 轮换（偶数周=A经典, 奇数周=B新鲜），保持新鲜感和渐进挑战
  2: {
    // weekday 由 getCurrentWeekGames 动态从 weekdayA/weekdayB 选取
    weekday: null,
    // 工作日方案 A 套（偶数周）——经典方案
    weekdayA: {
      MON: [
      ...
      MON: [
        {
          ...
          domains: ["SI", "COG"],
          duration: "15-20分钟",
          materials: ["密封塑料瓶2个（一瓶装温水，一瓶装凉水）", "不同材质小物品（毛球、木环、硅胶圈）", "浴巾"],
          scene: "地垫上，宝宝趴姿或靠坐",
          steps: [
            "让宝宝趴好（浴巾卷支撑），把温水瓶轻轻贴在她手背上——\"暖暖的~\"停留3秒，观察她的表情。",
            "换凉水瓶贴同样位置——\"凉凉的！\"对比她对温度差异的反应（可能缩手、可能好奇伸手抓）。",
            "把小毛球、木环、硅胶圈依次放在她面前，让她趴着自由抓取探索——每样命名质感\"毛毛的！硬硬的！软软的！\"",
            "最后把一个小物品藏在浴巾下，只露出一角——\"咦？躲起来了！你能找到吗？\"鼓励她拉开浴巾。"
          ],
          interaction: "温度+材质的双重感觉输入让大脑同时处理多个信息通道。趴姿下的手部探索同时训练核心力量。最后的藏找环节是客体永久性的自然延伸。",
          upgrade: "增加第三种温度——室温水瓶，让她体验三级温度梯度。或把物品藏在两层布下。",
          prematureNote: "温水不超过38度，凉水不低于20度。密封瓶确保拧紧不会漏。如果她对温度变化反应强烈（哭泣），改为只用室温物品。"
        }
      ],
      TUE: [
        {
          ...
          domains: ["GM", "SE"],
          duration: "15-20分钟",
          materials: ["靠枕3-4个", "柔软毯子", "宝宝最爱的玩具"],
          scene: "地板，铺好毯子",
          steps: [
            "用靠枕在地板上搭一个低矮的\"小山\"（高度约10-15cm）。让宝宝仰卧在\"山\"的一侧。",
            "你在\"山\"的另一侧露出笑脸：\"宝宝，爸爸在这边！翻过来找我呀！\"",
            "鼓励她翻身越过靠枕——这比平地翻身更有挑战，身体需要适应高度变化。如果卡住，轻托髋部辅助。",
            "成功翻越后热烈庆祝！\"你翻过山啦！太厉害了！\"然后抱起来亲一下，再放回起点重复。",
            "如果她趴在靠枕上不想翻，就让她趴着玩——靠枕上的趴姿是天然的核心力量训练。"
          ],
          interaction: "在有坡度的表面翻身=核心力量+平衡感的升级训练。\"翻过山找到爸爸\"的奖励机制让她主动挑战困难。失败了也没关系——趴在靠枕上本身就是很好的练习。",
          upgrade: "增加靠枕高度（20cm），或在\"山\"上铺一条不同材质的布料，增加触觉维度。",
          prematureNote: "靠枕要稳固不会滑动。高度从10cm开始，观察她的耐受。如果连续3次无法翻越就降低高度，确保成功体验。"
        }
      ],
      WED: [
        {
          ...
          domains: ["COG", "FM"],
          duration: "15-20分钟",
          materials: ["安全小物品3-4个（积木、小球、软环）", "小篮子或碗"],
          scene: "宝宝靠坐在你腿间或高脚椅上",
          steps: [
            "把一个积木放在宝宝左手里，确认她抓住了。然后在她右手边放另一个积木——观察她是否会把左手的递到右手，再去抓新的。",
            "如果她双手各抓一个就停住了——完全正常！6-8月的宝宝正在学习'手间传递'这个里程碑技能。",
            "示范把积木放进小碗里：\"放进去！叮！\"然后鼓励她模仿——\"你也放一个？\"",
            "把碗倒扣，积木在里面滚动发出声音——\"咕噜咕噜！在里面！\"引导她翻开碗找积木。"
          ],
          interaction: "手间传递（左↔右）是精细运动的关键里程碑，通常在6-8月出现。'放进→倒出'循环建立因果认知。不要帮她完成——让她自己试，哪怕笨拙地试10次。",
          upgrade: "用大小不同的物品，让她体验抓握力度的调节。或用透明碗让她看到里面的东西。",
          prematureNote: "物品大小确保她单手能抓握但不会整个塞进嘴里。观察双手使用的对称性——如果明显偏一侧使用，记录下来。"
        }
      ],
      THU: [
        {
          ...
          domains: ["LANG", "SI"],
          duration: "15-20分钟",
          materials: ["无——只需要你的手和声音"],
          scene: "面对面，宝宝靠坐或坐在你腿上",
          steps: [
            "面对面坐好，用慢节奏拍手唱\"拍~拍~手~\"，每个字配一下拍，重复3遍。观察她是否盯着你的手。",
            "握住她的小手，帮她一起拍——\"我们一起拍！拍~拍~拍~\"感受节奏的身体记忆。",
            "换节奏：快拍3下\"啪啪啪！\"然后暂停2秒——\"等一等~\"——再快拍3下。观察她是否在暂停时产生期待（身体前倾、嘴巴张开）。",
            "加入身体部位：\"拍拍手~\"（拍手）\"拍拍腿~\"（拍腿）\"拍拍肚子~\"（轻拍她肚子，她可能会笑）。"
          ],
          interaction: "节奏模式是语言韵律的基础——说话就是有节奏的声音。拍手时的暂停-期待循环训练'预测能力'，这是语言理解的认知前提。她笑的时候=大脑在说'我猜对了下一个会发生什么'。",
          upgrade: "尝试让她'接龙'：你拍2下停住，看她是否会自己拍第3下。这是轮流互动的升级版。",
          prematureNote: "节奏从非常慢开始（1秒1拍）。如果她被快节奏吓到，回到慢速。她不一定会拍手——盯着你看、身体晃动都是参与的信号。"
        }
      ],
      FRI: [
        {
          ...
          domains: ["SE", "COG"],
          duration: "15-20分钟",
          materials: ["大丝巾或薄围巾2条", "小镜子（可选）"],
          scene: "地垫上，宝宝仰卧或靠坐",
          steps: [
            "先用围巾轻轻盖住你自己的头——\"爸爸去哪了？\"停顿2秒，观察她的反应（可能盯着你、可能伸手去拉）。",
            "自己揭开围巾：\"Peekaboo！爸爸在这里！\"表情要超级惊喜。重复3次，让她熟悉这个'消失→出现'节奏。",
            "轻轻把围巾盖在她头上（半透明的，她能隐约看到光线）——\"宝宝去哪了？\"等她自己拉开或帮她揭开——\"找到你了！\"",
            "进阶：你和她各盖一条围巾，同时揭开——\"一起Peekaboo！\"如果旁边有镜子更有趣——她能看到揭开的过程。",
            "最后让她拿着围巾自由探索——抓、拉、挥舞、盖住玩具——都是自主玩法。"
          ],
          interaction: "Peekaboo的核心不是'好玩'，而是'安全的分离体验'。每次你消失又出现，她的大脑在学习：爱的人离开了，但他们会回来。这是客体永久性和依恋安全感的双重训练。当她开始主动参与（拉围巾找你），说明她从'被动接受'进入了'主动互动'阶段。",
          upgrade: "延长消失时间（从2秒到5秒），或者用围巾盖住一个玩具让她找。",
          prematureNote: "用半透明的薄围巾开始，确保她不会感到完全黑暗的恐惧。如果她盖上围巾后哭了，立刻揭开并拥抱——不强迫。"
        }
      ]
    },
    // 周末方案 A 套（奇数周使用）
      ...
      saturday: {
        morning: {
          main: {
            ...
            domains: ["GM", "SI", "SE"],
            duration: "25-30分钟",
            materials: ["长条游戏垫或连铺2块瑜伽垫", "玩具3-4个", "柔软靠枕做终点"],
            scene: "客厅地板，铺成长条形的游戏区",
            steps: [
              "把游戏垫铺成一个长条\"跑道\"（约1.5-2米长），终点放一个靠枕和她最爱的玩具。让宝宝仰卧在\"起点\"。",
              "你趴在终点那端，热情招手：\"宝宝，来找爸爸呀！\"——用你的笑脸作为她翻滚的终极动力。",
              "鼓励她翻身（仰→趴）前进，翻到趴姿后如果不会翻回，你可以在侧面轻轻引导她继续翻（趴→仰→趴）。",
              "每翻一次就夸张庆祝：\"翻过来了！再来一个！\"全程保持你在终点的吸引力。",
              "到达终点时给她一个大大的拥抱和亲吻：\"你翻到爸爸这里来啦！太了不起了！\""
            ],
            interaction: "连续翻滚是翻身能力的进阶版——从单次翻身到\"移动\"。大多数7个月左右的宝宝会自发用翻滚来\"移动\"，这是爬行的前奏。关键是让她享受这个过程，而不是追求距离。哪怕只翻了半圈也值得庆祝！",
            upgrade: "在\"跑道\"中间放一个小障碍（低矮的毛巾卷），让她翻过去时体验地面高低变化。",
            prematureNote: "长条游戏垫两侧用靠枕围起来，确保安全。不熟练翻身方向仍以温柔引导为主。如果她翻了2-3次开始烦躁，缩短距离让她能快速到达终点获得成就感。"
          },
          aux: {
            name: "趴姿打击乐",
            domains: ["SI", "FM", "COG"],
            duration: "10-15分钟",
            materials: ["不锈钢小碗", "木勺", "塑料碟子", "硅胶垫", "浴巾卷做胸部支撑"],
            scene: "地板游戏垫上",
            steps: [
              "浴巾卷支撑宝宝趴好，面前排列3种不同材质的\"鼓面\"：金属碗、塑料碟、硅胶垫。",
              "你先示范用木勺敲每种材质——\"当当当！\"\"啪啪啪！\"\"嘣嘣嘣！\"每种声音配夸张表情。",
              "把木勺递给她（或让她直接用手拍），鼓励她自由击打——\"你来！\"",
              "和她\"合奏\"：你敲一下等她敲一下，建立轮流节奏——\"轮到宝宝了！\""
            ],
            interaction: "趴姿+手部击打=核心力量+手眼协调+因果认知三合一训练。不同材质发出不同声音让她体验\"同一动作→不同结果\"的认知升级。",
            prematureNote: "木勺选短粗的，方便她握持。金属碗声音较大，如果她被吓到就先拿走，用塑料碟和硅胶垫开始。"
          }
        },
        afternoon: {
          outdoor: {
            ...
            domains: ["SI", "GM", "LANG"],
            duration: "30分钟",
            materials: ["大毯子", "遮阳帽", "触感不同的安全小物品3-4个（毛绒球、丝带、树叶）"],
            steps: [
              "找一片阴凉草地铺好毯子。让宝宝仰卧，你拿不同材质的小物品轮流在她手臂、脚底、脸颊轻轻触碰——\"毛毛的！\" \"滑滑的！\" \"痒痒的！\"",
              "翻到趴姿，在她面前的毯子上放几个小物品，让她趴着自由探索。偶尔捡一片安全的树叶在她手心里转——\"叶子在跳舞~\"",
              "抱起她，让她光手摸摸树干的粗糙表皮——\"摸摸大树！粗粗的！\"再摸你的脸——\"爸爸的脸！软软的！\"",
              "在微风中轻轻用丝带拂过她的手臂和脚背——\"风来了~丝带在飘~\"观察她伸手抓丝带的尝试。"
            ],
            interaction: "户外触觉体验的丰富度远超室内——阳光的温度、微风的触感、草叶的质地、树皮的粗糙。每一种新触感都是大脑在建立新的感觉神经连接。你的语言\"解说\"把每种触感和词汇配对。",
            prematureNote: "避免阳光直射。树叶确保无毒无刺。如果宝宝对某种材质表现出排斥（皱眉、推开），尊重她的边界，不强迫。"
          },
          indoor: {
            name: "水中漂浮秀",
            domains: ["SI", "COG", "FM"],
            duration: "15-20分钟",
            materials: ["大号浅水盆", "漂浮玩具（小鸭子、塑料球）", "沉底玩具（小勺子）", "防水围兜", "大毛巾"],
            steps: [
              "在客厅铺好大毛巾，放上浅水盆装入温水（3-5cm深就够）。让宝宝坐在你腿上或趴在你旁边看。",
              "放入一个小鸭子——\"看！鸭鸭浮起来了！\"推一下让它漂过去——\"游过去了！\"",
              "放入一个小勺子——\"咕噜！沉下去了！\"对比鸭子和勺子——\"鸭鸭浮着，勺子沉了！\"",
              "引导她伸手拍水面——\"啪！水花！好好玩！\"感受水的触感和阻力。",
              "如果她想抓漂浮的鸭子——太好了！在水中抓移动目标是精细运动的高级训练。"
            ],
            interaction: "浮沉对比是婴儿最早接触的物理概念之一。拍水→水花出现是因果认知的强化。水的触感（温度、阻力、流动性）提供了独特的感官体验。",
            prematureNote: "水温控制在37-38°C。水很浅（3-5cm），确保安全。全程看护不离手。如果她被溅到水而惊吓，暂停拍水，改为静静触摸水面。"
          }
        },
        reading: {
          book: "《小蓝和小黄》(李欧·李奥尼 著)",
          why: "极简主义色彩绘本，用色块讲故事。对这个月龄的宝宝，鲜明的色彩对比就是最好的视觉刺激。当当/京东有售，也有纸板书版本更适合宝宝翻。",
          howTo: "让宝宝靠在你怀里，你的声音从她头顶传下来。这本书的精髓在于颜色变化——蓝色和黄色混在一起变成绿色。每次出现颜色变化时，用手指指着画面让她注意。",
          script: [
            "\"看！这是小蓝~\"（指着蓝色圆点）\"蓝蓝的！\"",
            "\"这是小黄！\"（指着黄色圆点）\"黄黄的！\"",
            "\"他们抱在一起了！哇！变成绿色了！\"（声音惊喜）",
            "翻页时让她帮你翻——握着她的小手一起\"翻！\"每次翻页都是精细运动练习"
          ]
        }
      },
      sunday: {
        morning: {
          name: "周六精选重玩 + 微创新",
          note: "重复是学习的核心。选周六宝宝最投入的那个游戏重复一遍，但加入一个微小变化。这周的新游戏如果宝宝特别喜欢某个环节，今天就围绕那个环节深入玩！",
          variations: [
            "翻滚探险变化：换一个方向（从另一端出发），或在\"跑道\"上铺不同材质的布料段",
            "打击乐变化：换一批\"鼓面\"——试试铺了纸的桌面、倒扣的塑料碗、厚纸板",
            "角色变化：把终点的\"吸引者\"换成家里另一个人——观察她是否同样有翻滚动力"
          ]
        },
        afternoon: {
          name: "日常照料变游戏",
          scenes: [
            {
              scene: "换尿布时",
              script: "\"小脚丫探险家\"：脱掉袜子后，在她的脚底用不同材质轻轻触碰——棉花\"软软的~\"、你的下巴\"扎扎的~\"、冰凉的湿巾\"凉凉的~\"。每种触感说一个词，观察她脚趾的不同反应（展开/蜷缩）——这是足底敏感度和身体意识的训练。",
              domain: "SI + LANG"
            },
            {
              scene: "洗澡时",
              script: "\"水中拍拍乐\"：在浴缸水面放几个浮球，引导她拍打水面让浮球移动——\"拍！球球跑了！\"再教她用手舀水倒在自己肚子上——\"哗~水来了！\"水中的因果游戏让洗澡时光变成物理课。",
              domain: "FM + COG"
            },
            {
              scene: "吃辅食时",
              script: "\"颜色美食秀\"：把不同颜色的辅食（橙色胡萝卜泥、绿色西兰花泥、白色米糊）分开放在盘子里。每喂一口先指给她看：\"橙色！这是胡萝卜！\"让她用手指戳一戳食物的质地再入嘴——手指自主进食（BLW理念）是精细运动+自主性的双重训练。",
              domain: "FM + COG"
            }
          ]
        }
    ...
    // weekend 属性由 getCurrentWeekGames 动态计算（基于周次奇偶）
    weekend: null,
    morningRitual: {
...
Peekaboo.getCurrentWeekGames = function(date = new Date()) {
  ...
  let stageData = this.gameDB[stageId];
  if (!stageData) {
    ...
    stageData = this.gameDB[closest];
  }

  const weekNum = this.getWeekNumber(date);
  // 创建浅拷贝，避免修改原始 gameDB 对象
  const result = Object.assign({}, stageData);

  // A/B 工作日方案轮换（适用于有 weekdayA/weekdayB 的阶段）
  if (stageData.weekdayA && stageData.weekdayB) {
    // 奇数周=B套(新), 偶数周=A套(经典)
    result.weekday = (weekNum % 2 === 1) ? stageData.weekdayB : stageData.weekdayA;
  }

  // A/B 周末方案轮换（适用于有 weekendA/weekendB 的阶段）
  if (stageData.weekendA && stageData.weekendB) {
    // 奇数周=B套(新), 偶数周=A套(经典)
    result.weekend = (weekNum % 2 === 1) ? stageData.weekendB : stageData.weekendA;
  }
